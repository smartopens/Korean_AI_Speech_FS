...
from dataset import split_dataset, collate_fn
...
if __name__ == '__main__':
    ...
    args.add_argument('--spec_augment', type=bool, default=False)
    ...
    tokenizer = Wav2Vec2CTCTokenizer("./labels.json", unk_token="[UNK]", pad_token="[PAD]", word_delimiter_token="|")
    ...
    if config.mode == 'train':
        ...
        train_dataset, valid_dataset = split_dataset(config, os.path.join(os.getcwd(), 'transcripts.txt'), vocab, processor)
